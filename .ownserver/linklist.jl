...
# ╔═╡ f4f8f90d-29db-449c-a35d-4f8dc415483b
using JLD2, PlutoUI, Luxor,QRCode,HTTP

# ╔═╡ 128cf56d-8a01-4eff-a812-2d11fbb1b7cd
begin
	dir = @__DIR__
	baseurl = "https://teaching.frankhuettner.de/open?path="
	url = baseurl * dir * "/" * "linklist.jl"
	qrc = qrcode(url)	
	@svg begin
	    tiles = Tiler(350, 350, size(qrc)..., margin=0)
	    squares = first.(tiles)
	...
	end 350 350 "/tmp/qrcode"
end

# ╔═╡ cc56f93b-93a5-4399-8a04-db0272af4207
@bind reload_links Button("Reload links")

# ╔═╡ 9417954e-260d-4514-9b21-193feff6ad8d
begin 
	reload_links 
	@load "./md_linklist.jld2"
end;

# ╔═╡ 90e39966-48db-45f0-b0d5-c0f7ebfcc09e
begin 
	reload_links; 
	Markdown.parse(md_linklist)
end

# ╔═╡ a814b2e9-1337-41c4-a747-ffdeccf0dc1e
if true
	html"""
	<style>
	pluto-input {
...
QRCode = "6cfbe66a-a49d-11e9-1842-750d329cfcbb"
...
[[QRCode]]
deps = ["Compat", "FileIO", "ImageMagick", "Images"]
git-tree-sha1 = "4ea95ffa11cdb38bba2602990efc6cc7958f429f"
uuid = "6cfbe66a-a49d-11e9-1842-750d329cfcbb"
version = "0.1.0"
