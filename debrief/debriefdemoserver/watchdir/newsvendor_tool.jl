...
using PlutoUI, NewsvendorModel, Distributions, StatsPlots, StatsBase
...
begin
	nvm = NVModel(cost = c, price = p, demand = TruncatedNormal(mu, sigma, l, u), salvage = s, backlog = b, q_min = qmin, q_max = qmax)
	solve(nvm)
end
